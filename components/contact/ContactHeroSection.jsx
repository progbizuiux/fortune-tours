                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6 2xl:space-y-[44px]">
                  ...
                  <div className="relative flex flex-col justify-between 2xl:h-[80px]">
                    ...
                    <textarea
                      ...
                      className="w-full bg-transparent border-b-[0.5px] border-black/50 focus:border-black pb-1 sm:pb-1.5 2xl:pb-[16px] text-[13px] sm:text-[14px] md:text-[15px] 2xl:text-[16px] leading-[20px] 2xl:leading-[24px] text-black placeholder:text-black/35 font-sans font-light tracking-normal focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky transition-colors resize-y min-h-[80px] sm:min-h-[80px] 2xl:min-h-[96px] h-auto"
                    />
                  </div>
