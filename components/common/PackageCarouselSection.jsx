            ...
            {items.map((item) => (
              ...
              >
                ...
                <PackageCard
                  ...
                  titleClassName="lg:max-2xl:mb-[24px] lg:max-xl:text-[19px] lg:max-xl:leading-[24px] xl:max-2xl:text-[22px] xl:max-2xl:leading-[28.5px] 2xl:text-[22px] 2xl:leading-[28px]"
                  metaClassName="text-[13px] leading-[1.4] text-black/80 mb-[10px] lg:mb-[12px] lg:max-2xl:mb-[8px] lg:max-xl:text-[11.5px] lg:max-xl:leading-[1.4] xl:max-2xl:text-[13px] xl:max-2xl:leading-[1.4] 2xl:text-[13px] 2xl:leading-[1.4]"
                  experiencesClassName="lg:max-xl:text-[11.5px] lg:max-xl:leading-[1.4] xl:max-2xl:text-[14px] xl:max-2xl:leading-[1.4] 2xl:text-[16px] 2xl:leading-[20px]"
