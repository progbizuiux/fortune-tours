          ...
          {visibleDestinations.map((dest, i) => (
            <li key={dest.name} className="max-md:snap-center max-md:shrink-0 max-md:w-[85vw]">
              ...
              >
                ...
                <h3 className="mt-[16px] lg:max-xl:mt-[8px] xl:max-2xl:mt-[12px] 2xl:mt-[16px] text-black max-lg:text-[18px] lg:max-xl:text-[17px] xl:max-[1500px]:text-[21px] min-[1500px]:max-[1700px]:text-[26px]">
                  {dest.name}
                </h3>
              </Link>
            </li>
