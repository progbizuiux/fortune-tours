...
// Common slightly reduced font size for tablets, laptops and smaller desktops (md to 2xl).
// This ensures all hero titles share the same readable size in this screen range.
const HEADING_LG_TO_2XL = "md:max-xl:text-[44px] md:max-xl:leading-[1.1] xl:max-2xl:text-[55px] xl:max-2xl:leading-[1.1] min-[1500px]:max-2xl:text-[66px]!";
