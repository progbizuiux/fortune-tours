        ...
        <ul className="flex flex-col gap-[26px] lg:max-2xl:gap-[16px]">
          {SITE_MENU.primary.map((item, index) => (
            ...
            >
              ...
              <Link
                href={item.href}
                className="font-heading text-[32px] leading-none font-normal text-[#1D232A] lg:max-2xl:text-[22px] hover:text-sky inline-flex min-h-11 items-center transition-colors"
              >
                {item.label}
              </Link>
            </li>
        ...
        <ul className="flex flex-col gap-[9px] lg:max-2xl:gap-[4px]">
          {SITE_MENU.secondary.map((item, index) => (
            ...
            >
              <Link
                href={item.href}
                className="text-[18px] leading-none font-light text-[#454E56] lg:max-2xl:text-[15px] hover:text-sky flex min-h-9 items-center transition-colors"
              >
                {item.label}
              </Link>
            </li>
