        ...
        <ul className="flex flex-col gap-[26px] lg:max-2xl:gap-[16px]">
          {SITE_MENU.primary.map((item, index) => (
            ...
            >
              ...
              <Link
                href={item.href}
                className="font-heading text-[32px] leading-none font-normal text-[#1D232A] lg:max-xl:text-[17px] xl:max-[1500px]:text-[20.5px] min-[1500px]:max-[1700px]:text-[26px] min-[1700px]:text-[32px] hover:text-sky inline-flex min-h-11 items-center transition-colors"
              >
                {item.label}
              </Link>
            </li>
