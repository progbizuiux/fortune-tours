...
export function FaqSection({
  ...
  return (
    /* bg-cream is the brand #FAF7F2 (--color-cream in app/globals.css), not
       white — the FAQ closes the page against the footer and the warm ground
       is what separates it from the white sections above it. className is
       merged last, so a call site can still override it. */
    <section
      className={cn(
        "bg-cream pt-16 pb-16 md:pt-24 md:pb-24 lg:max-xl:pt-[45px] lg:max-xl:pb-[90px] xl:max-2xl:pt-[55px] xl:max-2xl:pb-[105px] 2xl:pt-[120px] 2xl:pb-[120px] relative z-10",
        className,
      )}
    >
      <Container>
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 xl:gap-[120px]">
          ...
          <div
            className={cn(
              "w-full lg:flex-1 mt-4 lg:mt-0",
              eyebrow && "lg:mt-[42px] xl:mt-[50px] 2xl:mt-[52px]",
            )}
          >
