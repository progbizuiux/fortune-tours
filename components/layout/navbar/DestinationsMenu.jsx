          ...
          >
            ...
            >
              ...
              <span className="absolute inset-x-0 bottom-0 flex flex-col p-4 text-white">
                <span className="text-body leading-tight font-medium lg:max-xl:text-[12.5px] xl:max-2xl:text-[13.5px] 2xl:text-[15px]">
                  {place.title}
                </span>
                <span className="text-small mt-1 leading-none font-light text-white/80 lg:max-xl:text-[11px] xl:max-2xl:text-[11.5px] 2xl:text-[13px]">
                  {place.tagline}
                </span>
              </span>
            </Link>
