...
const PACKAGES = {
  "kerala/lakshadweep-agatti-kalpitti": {
    ...
    whyUs: {
      ...
      description:
        "Visa rules, health precautions, park permits and long distances between destinations all need careful handling. Our experience helps take that complexity away.",
      features: [
        {
...
export async function getPackage(destination, slug) {
  ...
  return {
    ...
    whyUs: merge(local?.whyUs, entry.whyUs),
