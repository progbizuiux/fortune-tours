              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className={cn(
                        "font-sans text-[15px] leading-[1.4] font-light transition-colors lg:text-[18px]",
                        isOpen
                    ...
                    <div className="overflow-hidden">
                      <div className="flex flex-col gap-3 pb-6 lg:pr-12">
                        {item.answer.map((paragraph, i) => (
                          <p
                            key={i}
                            className="font-sans text-[13px] leading-[1.6] font-light text-black/70 lg:text-[16px] dark:text-cream/70"
                          >
                            {paragraph}
                          </p>
                        ))}
