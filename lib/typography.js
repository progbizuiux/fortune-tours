...
export const HERO_HEADING = `font-heading ${HEADING_SMALL} text-h1`;
...
export const HERO_HEADING_NARROW = `font-heading ${HEADING_SMALL} leading-[1.1118] lg:text-h2 xl:text-[clamp(2.5rem,4.8vw_-_7.16px,5.3125rem)]`;
