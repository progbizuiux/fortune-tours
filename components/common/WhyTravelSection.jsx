...
const WHY_TRAVEL_CARDS = [
  {
    ...
    icon: "/destinations/kerala/icons/goggle.svg",
    iconWidth: 28,
    iconHeight: 28,
  ...
  },
  {
    ...
    icon: "/destinations/kerala/icons/climb.svg",
    iconWidth: 28,
    iconHeight: 28,
  ...
  },
  {
    ...
    icon: "/destinations/kerala/icons/diamond.svg",
    iconWidth: 28,
    iconHeight: 28,
  ...
  },
  {
    ...
    icon: "/destinations/kerala/icons/support.svg",
    iconWidth: 31,
    iconHeight: 28,
    ...
    <section className="bg-cream spacing">
      <Container>
        <SectionHeading
          ...
          eyebrowClassName="lg:max-xl:text-[17px] xl:max-2xl:text-[20px] 2xl:text-[20px]"
