  ...
  return (
    <div className={cn("flex flex-col", className)}>
      {eyebrow && (
        <span
          className={cn(
            "font-top text-[12px] md:text-[14px] lg:max-xl:text-[13px] xl:max-2xl:text-[16px] 2xl:text-[16px] font-normal leading-[11.7px] text-black",
            eyebrowClassName,
          )}
        >
          {eyebrow}
      ...
      {title && (
        <Heading
          className={cn(
            "font-heading text-[25px] md:text-[30px] lg:max-xl:text-[26px] xl:max-2xl:text-[42px] 2xl:text-[45px] leading-[41.4px] md:leading-120 xl:leading-[41.4px] tracking-[-0.7px] mt-[9px] md:mt-[20px] text-navy",
            titleClassName,
          )}
        >
          {title}
