...
// /search is the one live route that can take any place name today, so it is
// where menu links land until per-destination pages exist. Kerala is the
// exception below — it already has a page of its own.
...
export const DESTINATION_REGIONS = [
  ...
  },
  {
    ...
    href: searchHref("South East Asia"),
    countries: [
      country("Borneo", "Orangutans • Rainforest"),
      country("Cambodia", "Angkor • Siem Reap"),
      country("Indonesia", "Bali • Komodo"),
